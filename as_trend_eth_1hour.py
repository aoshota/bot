...
# エントリー、決済、損切りの計算
# デモ用 money
def CalcMain(flag_just_time_1min, flag_just_time_1hour, data_now,data_sum, data_bb_20, cnt_bb_20, flag_plus, flag_minus, flag_position, money,money_tmp):
...
while True:
	...
	data_sum,data_bb_20,cnt_bb_20,flag_plus,flag_minus,flag_position,money,money_tmp = CalcMain(flag_just_time_1min,flag_just_time_1hour,data_now,data_sum,data_bb_20,cnt_bb_20,flag_plus,flag_minus,flag_position,money,money_tmp)
